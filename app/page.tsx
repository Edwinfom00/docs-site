...
import { getAllPackages, isNewPackage } from '@/lib/content';
      ...
      <main className="home-page">
        ...
        <section className="packages-section">
          ...
          <div className="packages-grid">
            {packages.map((pkg) => {
              const showNew = isNewPackage(pkg);
              return (
                <Link
                  key={pkg.slug}
                ...
                >
                  <div className="card-header">
                    {/* Icon tinted with the package color */}
                    <div
                      className="card-icon"
                      style={{ color: pkg.color, background: `${pkg.color}18` }}
                    >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      {/* NEW badge — visible for 7 days after latestVersionDate */}
                      {showNew && (
