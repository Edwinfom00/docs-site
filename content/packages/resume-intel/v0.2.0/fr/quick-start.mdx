...
- [Extraction spatiale](/docs/resume-intel/v0.2.0/fr/spatial-extraction) — comment les mises en page multicolonnes sont gérées
- [Décomposition par section](/docs/resume-intel/v0.2.0/fr/task-decomposition) — extraction parallèle avec 15 sections
- [Validation JSON](/docs/resume-intel/v0.2.0/fr/json-validation) — pipeline de réparation et retry
- [CLI](/docs/resume-intel/v0.2.0/fr/cli) — parser depuis le terminal
- [Référence API](/docs/resume-intel/v0.2.0/fr/api-reference) — documentation complète
