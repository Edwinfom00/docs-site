...
- Learn about [Spatial Extraction](/docs/resume-intel/v0.2.0/en/spatial-extraction) — how multi-column layouts are handled
- Configure [Task Decomposition](/docs/resume-intel/v0.2.0/en/task-decomposition) — parallel section extraction with 15 sections
- Understand [JSON Validation](/docs/resume-intel/v0.2.0/en/json-validation) — repair and retry pipeline
- Use the [CLI](/docs/resume-intel/v0.2.0/en/cli) — parse from the terminal
- See the full [API Reference](/docs/resume-intel/v0.2.0/en/api-reference)
