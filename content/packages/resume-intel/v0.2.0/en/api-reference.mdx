---
title: API Reference
description: Complete API reference for @edwinfom/resume-intel v0.2.0 — parseResume, options, return types, exported schemas, and utility functions.
---
...
Accepts the same options as `parseResume()`. See the [Streaming](/docs/resume-intel/v0.2.0/en/streaming) page for full documentation.
