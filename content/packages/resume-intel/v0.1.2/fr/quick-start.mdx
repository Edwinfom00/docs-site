...
- [Extraction spatiale](/docs/resume-intel/v0.1.2/fr/spatial-extraction) — comment les mises en page multicolonnes sont gérées
- [Décomposition par section](/docs/resume-intel/v0.1.2/fr/task-decomposition) — extraction parallèle avec 15 sections
- [Validation JSON](/docs/resume-intel/v0.1.2/fr/json-validation) — pipeline de réparation et retry
- [CLI](/docs/resume-intel/v0.1.2/fr/cli) — parser depuis le terminal
- [Référence API](/docs/resume-intel/v0.1.2/fr/api-reference) — documentation complète
