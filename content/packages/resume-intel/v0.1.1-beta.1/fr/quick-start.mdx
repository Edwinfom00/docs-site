...
- [Extraction spatiale](/docs/resume-intel/v0.1.1-beta.1/fr/spatial-extraction) — comment les mises en page multicolonnes sont gérées
- [Décomposition par section](/docs/resume-intel/v0.1.1-beta.1/fr/task-decomposition) — extraction parallèle par section
- [Validation JSON](/docs/resume-intel/v0.1.1-beta.1/fr/json-validation) — pipeline de réparation et retry
- [Référence API](/docs/resume-intel/v0.1.1-beta.1/fr/api-reference) — documentation complète
