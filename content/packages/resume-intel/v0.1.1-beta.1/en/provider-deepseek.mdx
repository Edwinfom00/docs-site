...
**Continuation after JSON** — DeepSeek V3 occasionally continues generating text after a valid JSON object. The per-section `maxTokens` cap in v0.1.1-beta.1 eliminates this.
