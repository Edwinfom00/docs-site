...
- Learn about [Spatial Extraction](/docs/resume-intel/v0.1.1-beta.1/en/spatial-extraction) — how multi-column layouts are handled
- Configure [Task Decomposition](/docs/resume-intel/v0.1.1-beta.1/en/task-decomposition) — parallel per-section extraction
- Understand [JSON Validation](/docs/resume-intel/v0.1.1-beta.1/en/json-validation) — repair and retry pipeline
- See the full [API Reference](/docs/resume-intel/v0.1.1-beta.1/en/api-reference)
