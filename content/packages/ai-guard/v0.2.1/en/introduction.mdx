...
- `registerModelPricing()` — register any custom model at runtime
- New built-in models: `gemini-2.5-flash`, `gemini-2.5-pro`, `gpt-4.1`, `gpt-4.1-mini`, `claude-3-7-sonnet-20250219`
- New schema exports: `extractJSON()`, `repairJSON()`
- New budget export: `estimateTokensByChars()`
- New PII export: `getPatternsForTargets()`
- Interactive [Playground](/docs/ai-guard/v0.2.1/en/playground) — run all standalone tests in your browser

See the full [Changelog](/docs/ai-guard/v0.2.1/en/changelog) for details.
