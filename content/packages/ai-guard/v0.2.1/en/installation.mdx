...
> Zod is completely optional — you can use a custom validator function instead. See [Custom Adapter](/docs/ai-guard/v0.2.1/custom-adapter).
...
See [Tree-Shakeable Sub-paths](/docs/ai-guard/v0.2.1/tree-shaking) for the full list.
